...
app.get('/version', (req, res) => {
  res.json({
    latestVersion: 9,
    downloadUrl: "https://github.com/jackkerry27-a11y/isdemir-chat-server/releases/download/v9.0/app-release.apk"
  });
});
...
let liveShipsList = [
  ...
  // 4. İÇ LİMAN RÖMORKÖR VE KILAVUZ FİLOSU (Ekran görüntüsündeki güncel gemiler)
  {
    ...
    islem: 'Yukleme',
    miktar: 0,
    gemiTipi: 'Harbour Tug',
    bayrak: '🇹🇷 Türkiye',
    imoNo: 'MMSI 271000001',
    iskeleNo: 'İç Havuz',
    progress: 1.0,
    lat: 36.7258,
    lng: 36.1915,
  ...
  },
  {
    ...
    gemiTipi: 'Harbour Tug',
    bayrak: '🇹🇷 Türkiye',
    imoNo: 'MMSI 271000003',
    iskeleNo: 'Güney Rıhtımı',
    progress: 1.0,
    lat: 36.7235,
    lng: 36.1975,
    heading: 120.0,
